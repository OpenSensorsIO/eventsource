...
type Msg
    ...
    | Die String
    | GoodOpen String ES.EventSource
    | BadOpen String
    ...
    case selfMsg of
        ...
        GoodOpen name socket ->
            case Dict.get name state.queues of
                ...
                Just messages ->
                    List.foldl (\msg task -> ES.send socket msg &> task)
...
open : String -> Platform.Router msg Msg -> Task ES.BadOpen ES.EventSource
open name router =
    ES.open name
